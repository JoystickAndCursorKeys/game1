class PaintView  {
	...
	transformMouseCoords ( xy ) {
		...
		xy2[ 0 ] = Math.round( vxf );
		xy2[ 1 ] = Math.round( vyf );
	...
	timerUpdateView( _paintCanvas, _paintContext, _overlay ) {

		_overlay.update();
		this.updateView( _paintCanvas, _paintContext, _overlay );


	}

	resetView( _paintCanvas, _paintContext, _overlay ) {
	...
	updateView( _paintCanvas, _paintContext, _overlay ) {
